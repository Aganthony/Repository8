...
from barkyapi.permissions import IsPatientOrHealthcareProviderOrReadOnly  # Adjusted permission class
from barkyapi.serializers import PatientSerializer, HealthMetricSerializer, TreatmentPlanSerializer, UserSerializer
